...
text="any of an infinite variety of curves formed by combining two mutually perpendicular simple harmonic motions commonly exhibited by the oscilloscope, and used in studying frequency, amplitude, and phase relations of harmonic variables."
st.text(text)
